...
export function PeriodSummaryCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
    >
      <Card className="border-gray-200 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md hover:border-gray-300 active:translate-y-0 active:shadow-sm">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-stretch sm:justify-between">
        <div className="flex-1">
          <div className="text-sm font-medium text-gray-500">{periodLabel}</div>
          <div className={`mt-1 text-2xl font-bold ${profitColor}`}>
