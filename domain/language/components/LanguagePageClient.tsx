  ...
  return (
    <main className="ps-10">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <Button size="md">확인</Button> <Button size="md" color="muted" className="mr-1">취소</Button>
          <Button size="md" color="error">삭제</Button> <Button size="md" className="mr-1" color="secondary">임시저장</Button>
          <Button size="md" color="success">제출</Button>
        </div>
      </div>
